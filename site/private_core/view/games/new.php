...
<main>
	...
	<form id="new-game" method="POST">
		<fieldset>
			...
			<?= (new o\SearchElement('Platforms', '/search/platforms', true, null, ['name' => 'platform', 'modal' => '/platforms/new', 'modal-tgt-id' => 'new-platform', 'modal-value-key' => 'InPlatformName'], null, true))->buildElement() ?>
			<br>
