...
<main>
	...
	<form id="new-game" method="POST">
		<fieldset>
			...
			<?= (new o\SearchElement('Platforms', '/search/platforms', true, null, ['name' => 'platform', 'modal' => '/platforms/new', 'modal-tgt-id' => 'new-platform', 'modal-value-key' => 'NewPlatform'], null, true))->buildElement() ?>
			<br>
