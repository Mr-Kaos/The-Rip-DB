...
<main>
	...
	<form id="edit-game" method="POST">
		<fieldset>
			...
			<?= (new o\SearchElement('Platforms', '/search/platforms', true, $game['Platforms'], ['name' => 'platform', 'modal' => '/platforms/new', 'modal-tgt-id' => 'new-platform', 'modal-value-key' => 'InPlatformName'], null, true))->buildElement() ?>
			<br>
