...
CALL usp_InsertRip('MEGALOVANIA - Undertale', 'Descending MEGALOVANIA', NULL, '2016-01-12', '0137', 'https://www.youtube.com/watch?v=Q9wDLSrLeUE', 3, 1, '[1]', '{"6": {"timestamps":[{"start":"0000","end":"0137"}],"comment":null}, "7": {"timestamps":[{"start":"0000","end":"0137"}],"comment":null}}', '{"2":null}');
...
CALL usp_InsertRip('Last Goodbye (Beta Mix) - Undertale', NULL, NULL, '2016-01-29', '0215', 'https://www.youtube.com/watch?v=gIEbix3m68g', 3, 1, '[8]', '{"7": {"timestamps":[{"start":"0000","end":"0215"}],"comment":null}}', '{"5":null}');
...
-- CALL usp_InsertRip_Sample('', NULL, NULL, '2016-01-20', '', 1, '', 1, '[1]', '[]', '[]');