...
CREATE TABLE RipJokes (
	...
	CONSTRAINT RipJokes_Rips_FK FOREIGN KEY (RipID) REFERENCES Rips(RipID) ON DELETE CASCADE,
	CONSTRAINT RipJokes_Jokes_FK FOREIGN KEY (JokeID) REFERENCES Jokes(JokeID) ON DELETE CASCADE
)
ENGINE=InnoDB
